...
public class Activity_BTLE_Services extends AppCompatActivity implements ExpandableListView.OnChildClickListener {
    ...
    public static final String EXTRA_NAME = "com.example.bleh.myapplication.Activity_BTLE_Services.NAME";
    public static final String EXTRA_ADDRESS = "com.example.bleh.myapplication.Activity_BTLE_Services.ADDRESS";
