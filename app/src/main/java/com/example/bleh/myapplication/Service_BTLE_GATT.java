...
public class Service_BTLE_GATT extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED = "com.example.bleh.myapplication.Service_BTLE_GATT.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED = "com.example.bleh.myapplication.Service_BTLE_GATT.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED = "com.example.bleh.myapplication.Service_BTLE_GATT.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE = "com.example.bleh.myapplication.Service_BTLE_GATT.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_UUID = "com.example.bleh.myapplication.Service_BTLE_GATT.EXTRA_UUID";
    public final static String EXTRA_DATA = "com.example.bleh.myapplication.Service_BTLE_GATT.EXTRA_DATA";
